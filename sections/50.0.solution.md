...
In order to solve the problem I have created a system named Skeem. This chapter acts as a high level overview to Skeems functionality, and how it is to be used. It will not cover how the system functions.
